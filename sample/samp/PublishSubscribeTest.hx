...
//    import flash.utils.Timer;
    ...
    class PublishSubscribeTest extends AbstractTest implements BasicConsumer implements LifecycleEventHandler {
        ...
        public function new(_root:DisplayObjectContainer, _t:TextField, _t2:TextField)
        {
			...
			player1 = new Sprite();
			drawPlayer(player1, 0xff0000, 0, 0);
			player2 = new Sprite();
			drawPlayer(player2, 0x0000ff, 0, 0);
        ...
        public function afterOpen():Void {
			trace("PublishSubscribeTest afterOpen");
            openChannel(runPublishTest);
        }

        public override function openChannel(_callback:Dynamic):Void {
			//trace("PublishSubscribeTest openChannel");
			var _this = this;
            var whoCares:Dynamic = function(event:ProtocolEvent):Void{
                //_this.log("whoCares called");
            };
        ...
        public function runPublishTest(event:ProtocolEvent):Void {
			//trace("PublishSubscribeTest runPublishTest");
 ...
 //       }
        ...
        public function onDeliver(method:Deliver,
            ...
            if (data.bytesAvailable > 0) {
				...
				drawPlayer(player2, 0x0000ff, x, y);
            }
        }
		...
		public function onMouseMove(e:MouseEvent):Void {
			...
			drawPlayer(player1, 0xff0000, e.stageX, e.stageY);
            publish(data);
		}
    }
